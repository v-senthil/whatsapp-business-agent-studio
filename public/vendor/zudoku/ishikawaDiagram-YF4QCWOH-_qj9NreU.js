...
import { H as t, K as n, U as r, a as i, c as a, s as o, v as s, w as c, x as l, y as u } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { p as d } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { t as f } from "./chunk-WU5MYG2G-yvpvq9O9.js";
import { t as p } from "./rough.esm-B7woRVjF.js";
...
var h = m, g = class {
	...
	let i = r.db.getRoot();
	if (!i) return;
	let a = l(), { look: o, handDrawnSeed: s, themeVariables: c } = a, u = d(a.fontSize)[0] ?? _, m = o === "handDrawn", h = i.children ?? [], g = a.ishikawa?.diagramPadding ?? 20, y = a.ishikawa?.useMaxWidth ?? !1, b = f(t), x = b.append("g").attr("class", "ishikawa"), S = m ? p.svg(b.node()) : void 0, C = S ? {
		roughSvg: S,
		seed: s ?? 0,
