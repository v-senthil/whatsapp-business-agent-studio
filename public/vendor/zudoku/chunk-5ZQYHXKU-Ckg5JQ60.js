...
import { R as r, h as i, p as a, r as o, s } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { t as c } from "./dist-Co3fodqD.js";
...
}, "detectInit"), dt = /* @__PURE__ */ t(function(t, n = null) {
	try {
...
`, "ig");
		...
		let a, o = [];
		for (; (a = i.exec(t)) !== null;) if (a.index === i.lastIndex && i.lastIndex++, a && !n || n && a[1]?.match(n) || n && a[2]?.match(n)) {
...
}, "calculatePoint"), yt = /* @__PURE__ */ t((t, n, r) => {
