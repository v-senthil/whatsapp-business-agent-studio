...
import { O as r, T as i, a, b as o, c as s, it as c, s as l, x as u, z as d } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { t as f } from "./channel-LkPLlkYs.js";
import { A as p, B as m, C as h, D as g, E as _, F as v, H as y, I as b, L as x, M as S, N as C, O as w, P as T, R as E, S as D, T as O, U as k, V as A, W as j, a as M, et as ee, g as N, j as te, k as ne, l as re, v as ie, w as ae, x as oe, z as se } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { t as ce } from "./line-BGhcYRdL.js";
import { n as le } from "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import { t as ue } from "./chunk-FMBD7UC4-CYttHLFx.js";
import { n as de, t as P } from "./chunk-BSJP7CBP-D9ENIqdp.js";
import { n as fe, t as pe } from "./chunk-L5ZTLDWV-D-Agyo9x.js";
import { t as me } from "./graphlib-ZWHIaefB.js";
...
var U = /* @__PURE__ */ t(async (e, t, n, r = !1, a = !1) => {
	...
	let r = u(), a = i(r), o = e.insert("g").attr("class", "edgeLabel"), s = o.insert("g").attr("class", "label"), c = t.labelType === "markdown", l = await le(e, t.label, {
		style: t.labelStyle,
		useHtmlLabels: a,
		addSvgBackground: c,
		isNode: !1,
...
var at = /* @__PURE__ */ t((t, n) => {
	...
	let r = n.updatedPath ? n.updatedPath : n.originalPath, { subGraphTitleTotalMargin: i } = fe(u());
	if (t.label) {
...
var K = {
	...
	let m;
	m = t.labelType === "markdown" ? le(f, d(M(p), o), {
		useHtmlLabels: c,
	...
	if (i(o)) {
		...
		await pe(e, p), h = e.getBoundingClientRect(), t.attr("width", h.width), t.attr("height", h.height);
	}
