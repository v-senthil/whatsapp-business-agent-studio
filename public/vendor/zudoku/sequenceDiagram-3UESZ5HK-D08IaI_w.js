...
import { A as r, F as i, G as a, H as o, K as s, O as c, U as l, a as u, b as d, c as f, i as p, r as m, s as h, v as g, w as _, x as v, y, z as b } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { t as x } from "./dist-Co3fodqD.js";
import { g as S, p as C } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { a as w, c as T, i as E, n as D, r as O, s as k } from "./chunk-ND2GUHAM-DBZVMcxd.js";
import { t as A } from "./chunk-QZHKN3VN-Bm74hFbO.js";
import { n as j, t as M } from "./chunk-XPW4576I-CNNdiTBE.js";
...
`;
	...
	let c = i.db.getActors(), l = c.get(n.from), u = c.get(n.to), d = r.sequenceVisible, f = l.x + l.width / 2, p = u.x + u.width / 2, m = f <= p, h = tt(n, i), g = e.append("g"), _ = /* @__PURE__ */ t((e, t) => {
		let n = e ? 16.5 : -16.5;
		return t ? -n : n;
...
var Ke = /* @__PURE__ */ t(async function(r, i, a, o) {
	...
	Q.init(), e.debug(o.db);
	let m = s === "sandbox" ? d.select(`[id="${i}"]`) : n(`[id="${i}"]`), h = o.db.getActors(), g = o.db.getCreatedActors(), _ = o.db.getDestroyedActors(), y = o.db.getBoxes(), b = o.db.getActorKeys(), x = o.db.getMessages(), S = o.db.getDiagramTitle(), C = o.db.hasAtLeastOneBox(), w = o.db.hasAtLeastOneBoxWithTitle(), T = await qe(h, x, o);
	...
	for (let t of x) {
		...
		switch (t.type) {
			case o.db.LINETYPE.NOTE:
				Q.resetVerticalPos(), r = t.noteModel, await Me(m, r, t.id);
				break;
			case o.db.LINETYPE.ACTIVE_START:
				Q.newActivation(t, m, h);
				break;
			...
			case o.db.LINETYPE.LOOP_START:
				$(D, t, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case o.db.LINETYPE.LOOP_END:
				n = Q.endLoop(), await X.drawLoop(m, n, "loop", Z, t), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			...
			case o.db.LINETYPE.OPT_END:
				n = Q.endLoop(), await X.drawLoop(m, n, "opt", Z, t), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.ALT_START:
				$(D, t, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case o.db.LINETYPE.ALT_ELSE:
				$(D, t, Z.boxMargin + Z.boxTextMargin, Z.boxMargin, (e) => Q.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.ALT_END:
				n = Q.endLoop(), await X.drawLoop(m, n, "alt", Z, t), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.PAR_START:
			case o.db.LINETYPE.PAR_OVER_START:
				$(D, t, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e)), Q.saveVerticalPos();
				break;
			case o.db.LINETYPE.PAR_AND:
				$(D, t, Z.boxMargin + Z.boxTextMargin, Z.boxMargin, (e) => Q.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.PAR_END:
				n = Q.endLoop(), await X.drawLoop(m, n, "par", Z, t), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			...
			case o.db.LINETYPE.CRITICAL_END:
				n = Q.endLoop(), await X.drawLoop(m, n, "critical", Z, t), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			case o.db.LINETYPE.BREAK_START:
				$(D, t, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) => Q.newLoop(e));
				break;
			case o.db.LINETYPE.BREAK_END:
				n = Q.endLoop(), await X.drawLoop(m, n, "break", Z, t), Q.bumpVerticalPos(n.stopy - Q.getVerticalPos()), Q.models.addLoop(n);
				break;
			default: try {
				i = t.msgModel, i.starty = Q.getVerticalPos(), i.sequenceIndex = k, i.sequenceVisible = o.db.showSequenceNumbers(), i.id = t.id, i.from = t.from, i.to = t.to;
				let e = await Le(m, i);
				Ge(t, i, e, N, h, g, _), j.push({
					messageModel: i,
					lineStartY: e,
					msg: t
	...
	e.debug("createdActors", g), e.debug("destroyedActors", _), await Be(m, h, b, !1, i, o, E);
	...
	m.attr("viewBox", F.startx - Z.diagramMarginX + " -" + (Z.diagramMarginY + te) + " " + R + " " + (L + te + ne)), e.debug("models:", Q.models);
}, "draw");
async function qe(t, n, i) {
	let a = {};
	for (let e of n) if (t.get(e.to) && t.get(e.from)) {
		...
		let o = e.placement !== void 0, s = !o, c = o ? Fe(Z) : Pe(Z), l = e.wrap ? S.wrapLabel(e.message, Z.width - 2 * Z.wrapPadding, c) : e.message, u = (r(l) ? await p(e.message, v()) : S.calculateTextDimensions(l, c)).width + 2 * Z.wrapPadding;
...
var Xe = /* @__PURE__ */ t(async function(t, n, i) {
	let a = n.get(t.from), o = n.get(t.to), s = a.x, c = o.x, l = t.wrap && t.message, u = r(t.message) ? await p(t.message, v()) : S.calculateTextDimensions(l ? S.wrapLabel(t.message, Z.width, Fe(Z)) : t.message, Fe(Z)), d = {
	...
	return t.placement === i.db.PLACEMENT.RIGHTOF ? (d.width = l ? h.getMax(Z.width, u.width) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s + (a.width + Z.actorMargin) / 2) : t.placement === i.db.PLACEMENT.LEFTOF ? (d.width = l ? h.getMax(Z.width, u.width + 2 * Z.noteMargin) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s - d.width + (a.width - Z.actorMargin) / 2) : t.to === t.from ? (u = S.calculateTextDimensions(l ? S.wrapLabel(t.message, h.getMax(Z.width, a.width), Fe(Z)) : t.message, Fe(Z)), d.width = l ? h.getMax(Z.width, a.width) : h.getMax(a.width, Z.width, u.width + 2 * Z.noteMargin), d.startx = s + (a.width - d.width) / 2) : (d.width = Math.abs(s + a.width / 2 - (c + o.width / 2)) + Z.actorMargin, d.startx = s < c ? s + a.width / 2 - Z.actorMargin / 2 : c + o.width / 2 - Z.actorMargin / 2), l && (d.message = S.wrapLabel(t.message, d.width - 2 * Z.wrapPadding, Fe(Z))), e.debug(`NM:[${d.startx},${d.stopx},${d.starty},${d.stopy}:${d.width},${d.height}=${t.message}]`), d;
...
}, "buildMessageModel"), it = /* @__PURE__ */ t(async function(t, n, r, i) {
	let a = {}, o = [], s, c, l;
	for (let e of t) {
		switch (e.type) {
			...
			case i.db.LINETYPE.ACTIVE_START:
				{
					let t = n.get(e.from ? e.from : e.to.actor), r = Ue(e.from ? e.from : e.to.actor).length, i = t.x + t.width / 2 + (r - 1) * Z.activationWidth / 2, a = {
						startx: i,
		...
		e.placement === void 0 ? (l = rt(e, n, i), e.msgModel = l, l.startx && l.stopx && o.length > 0 && o.forEach((t) => {
			if (s = t, l.startx === l.stopx) {
				let t = n.get(e.from), r = n.get(e.to);
				s.from = h.getMin(t.x - l.width / 2, t.x - t.width / 2, s.from), s.to = h.getMax(r.x + l.width / 2, r.x + t.width / 2, s.to), s.width = h.getMax(s.width, Math.abs(s.to - s.from)) - Z.labelBoxWidth;
			} else s.from = h.getMin(l.startx, s.from), s.to = h.getMax(l.stopx, s.to), s.width = h.getMax(s.width, l.width) - Z.labelBoxWidth;
		})) : (c = await Xe(e, n, i), e.noteModel = c, o.forEach((e) => {
