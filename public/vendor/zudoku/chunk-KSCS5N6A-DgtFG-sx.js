import { g as e, h as t, p as n } from "./src-CXddVwgO.js";
import { T as r, b as i, x as a } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { $ as o, J as s, K as c, Q as l, X as u, Y as d, Z as f, et as p, g as m, nt as h, q as g, rt as _, tt as v, u as y } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { t as b } from "./line-BGhcYRdL.js";
import { n as x } from "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import { i as S, n as ee, r as C, t as w } from "./chunk-BSJP7CBP-D9ENIqdp.js";
import { n as T } from "./chunk-L5ZTLDWV-D-Agyo9x.js";
import { i as E, n as D } from "./chunk-NZK2D7GU-vzBS4EZW.js";
import { t as te } from "./rough.esm-B7woRVjF.js";
import { r as O } from "./chunk-3OPIFGDE-BwYSS-16.js";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/chunk-KSCS5N6A.mjs
var ne = /* @__PURE__ */ t((e, t, n, r, i, a = !1, o) => {
	...
	"dependency",
	"barb"
], j = /* @__PURE__ */ t((t, n, r, i, a, o, s = !1, c) => {
...
}, "addEdgeMarker"), re = /* @__PURE__ */ t((e) => typeof e == "string" ? e : a()?.flowchart?.curve, "resolveEdgeCurveType"), M = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ t(() => {
	M.clear(), N.clear();
}, "clear"), F = /* @__PURE__ */ t((e) => e ? typeof e == "string" ? e : e.reduce((e, t) => e + ";" + t, "") : "", "getLabelStyles"), I = /* @__PURE__ */ t(async (t, i) => {
	...
	let h;
	if (i.startLabelLeft) {
		let e = t.insert("g").attr("class", "edgeTerminals"), r = e.insert("g").attr("class", "inner"), a = await O(r, i.startLabelLeft, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).startLeft = e, L(h, i.startLabelLeft);
	}
	if (i.startLabelRight) {
		let e = t.insert("g").attr("class", "edgeTerminals"), r = e.insert("g").attr("class", "inner"), a = await O(r, i.startLabelRight, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
			let e = a.children[0], t = n(a);
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).startRight = e, L(h, i.startLabelRight);
	}
	if (i.endLabelLeft) {
		let e = t.insert("g").attr("class", "edgeTerminals"), r = e.insert("g").attr("class", "inner"), a = await O(e, i.endLabelLeft, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
			let e = a.children[0], t = n(a);
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).endLeft = e, L(h, i.endLabelLeft);
	}
	if (i.endLabelRight) {
		let e = t.insert("g").attr("class", "edgeTerminals"), r = e.insert("g").attr("class", "inner"), a = await O(e, i.endLabelRight, F(i.labelStyle) || "", !1, !1);
		h = a;
		let o = a.getBBox();
		if (s) {
			let e = a.children[0], t = n(a);
		...
		r.attr("transform", w(o, s)), N.get(i.id) || N.set(i.id, {}), N.get(i.id).endRight = e, L(h, i.endLabelRight);
	}
	return f;
}, "insertEdgeLabel");
function L(e, t) {
...
var R = /* @__PURE__ */ t((t, n) => {
	...
	if (t.startLabelLeft) {
		let e = N.get(t.id).startLeft, n = t.x, i = t.y;
		if (r) {
	...
	if (t.startLabelRight) {
		let e = N.get(t.id).startRight, n = t.x, i = t.y;
		if (r) {
	...
	if (t.endLabelLeft) {
		let e = N.get(t.id).endLeft, n = t.x, i = t.y;
		if (r) {
	...
	if (t.endLabelRight) {
		let e = N.get(t.id).endRight, n = t.x, i = t.y;
		if (r) {
...
var U = /* @__PURE__ */ t(function(e, t, n) {
	let r = t.x - e.x, i = t.y - e.y, a = n / Math.sqrt(r * r + i * i);
	return {
		x: t.x - a * r,
		y: t.y - a * i
	};
}, "findAdjacentPoint"), ie = /* @__PURE__ */ t(function(t) {
	let { cornerPointPositions: n } = H(t), r = [];
	for (let i = 0; i < t.length; i++) if (n.includes(i)) {
		let n = t[i - 1], a = t[i + 1], o = t[i], s = U(n, o, 5), c = U(a, o, 5), l = c.x - s.x, u = c.y - s.y;
		r.push(s);
	...
	return r;
}, "fixCorners"), W = /* @__PURE__ */ t((e, t, n) => {
	let r = e - t - n, i = Math.floor(r / 4);
	return `0 ${t} ${Array(i).fill("2 2").join(" ")} ${n}`;
}, "generateDashArray"), G = /* @__PURE__ */ t(function(t, r, i, x, C, w, T, E = !1) {
	if (!T) throw Error(`insertEdge: missing diagramId for edge "${r.id}" \u2014 edge IDs require a diagram prefix for uniqueness`);
	let { handDrawnSeed: O } = a(), k = r.points, A = !1, j = C;
	var M = w;
	let N = [];
	for (let e in r.cssCompiledStyles) D(e) || N.push(r.cssCompiledStyles[e]);
	e.debug("UIO intersect check", r.points, M.x, j.x), M.intersect && j.intersect && !E && (k = k.slice(1, r.points.length - 1), k.unshift(j.intersect(k[0])), e.debug("Last point UIO", r.start, "-->", r.end, k[k.length - 1], M, M.intersect(k[k.length - 1])), k.push(M.intersect(k[k.length - 1])));
	let P = btoa(JSON.stringify(k));
	r.toCluster && (e.info("to cluster abc88", i.get(r.toCluster)), k = V(r.points, i.get(r.toCluster).node), A = !0), r.fromCluster && (e.debug("from cluster abc88", i.get(r.fromCluster), JSON.stringify(k, null, 2)), k = V(k.reverse(), i.get(r.fromCluster).node).reverse(), A = !0);
	let F = k.filter((e) => !Number.isNaN(e.y)), I = re(r.curve);
	I !== "rounded" && (F = ie(F));
	let L = _;
	switch (I) {
		case "linear":
	...
	let { x: R, y: z } = ee(r), B = b().x(R).y(z).curve(L), H;
	switch (r.thickness) {
		case "normal":
	...
	let U, G = I === "rounded" ? K(J(F, r), 5) : B(F), q = Array.isArray(r.style) ? r.style : [r.style], Y = q.find((e) => e?.startsWith("stroke:")), X = "";
	...
	if (r.look === "handDrawn") {
		...
		H += " transition", U = n(i).select("path").attr("id", `${T}-${r.id}`).attr("class", " " + H + (r.classes ? " " + r.classes : "") + (X ? " " + X : "")).attr("style", q ? q.reduce((e, t) => e + ";" + t, "") : "");
		let a = U.attr("d");
		U.attr("d", a), t.node().appendChild(U.node());
	} else {
		let e = N.join(";"), n = q ? q.reduce((e, t) => e + t + ";", "") : "", i = (e ? e + ";" + n + ";" : n) + ";" + (q ? q.reduce((e, t) => e + ";" + t, "") : "");
		U = t.append("path").attr("d", G).attr("id", `${T}-${r.id}`).attr("class", " " + H + (r.classes ? " " + r.classes : "") + (X ? " " + X : "")).attr("style", i), Y = i.match(/stroke:([^;]+)/)?.[1], Z = r.animate === !0 || !!r.animation || e.includes("animation");
		let a = U.node(), o = typeof a.getTotalLength == "function" ? a.getTotalLength() : 0, s = S[r.arrowTypeStart] || 0, c = S[r.arrowTypeEnd] || 0;
		if (r.look === "neo" && !Z) {
			let e = `stroke-dasharray: ${r.pattern === "dotted" || r.pattern === "dashed" ? W(o, s, c) : `0 ${s} ${o - s - c} ${c}`}; stroke-dashoffset: 0;`;
			U.attr("style", e + U.attr("style"));
		}
	}
	U.attr("data-edge", !0), U.attr("data-et", "edge"), U.attr("data-id", r.id), U.attr("data-points", P), U.attr("data-look", y(r.look)), r.showPoints && F.forEach((e) => {
	...
	let ae = !Z && r?.look === "neo";
	ne(U, r, Q, T, x, ae, Y);
	let oe = Math.floor(k.length / 2), se = k[oe];
	m.isLabelCoordinateInPath(se, U.attr("d")) || (A = !0);
	let $ = {};
...
function J(e, t) {
	...
	if (e.length >= 2 && C[t.arrowTypeStart]) {
		let r = C[t.arrowTypeStart], i = e[0], a = e[1], { angle: o } = q(i, a), s = r * Math.cos(o), c = r * Math.sin(o);
		n[0].x = i.x + s, n[0].y = i.y + c;
	}
	let r = e.length;
	if (r >= 2 && C[t.arrowTypeEnd]) {
		let i = C[t.arrowTypeEnd], a = e[r - 1], o = e[r - 2], { angle: s } = q(o, a), c = i * Math.cos(s), l = i * Math.sin(s);
