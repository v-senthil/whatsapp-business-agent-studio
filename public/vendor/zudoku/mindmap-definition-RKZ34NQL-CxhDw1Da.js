...
import { b as n, et as r, f as i, k as a, rt as o, tt as s, x as c, z as l } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import "./chunk-BSJP7CBP-D9ENIqdp.js";
import "./chunk-L5ZTLDWV-D-Agyo9x.js";
import { t as u } from "./chunk-55IACEB6-DwoZLfWV.js";
import { t as d } from "./chunk-2J33WTMH-CCkbVqsI.js";
import "./chunk-NZK2D7GU-vzBS4EZW.js";
import "./chunk-3OPIFGDE-BwYSS-16.js";
import "./chunk-KSCS5N6A-DgtFG-sx.js";
import { r as f, t as p } from "./chunk-LZXEDZCA-D8lb5wsM.js";
...
var x = b, S = 12, C = {
	...
	addNode(t, n, r, a) {
		...
		let s = c(), u = s.mindmap?.padding ?? i.mindmap.padding;
		switch (a) {
		...
		let d = {
			...
			type: a,
			children: [],
			width: s.mindmap?.maxNodeWidth ?? i.mindmap.maxNodeWidth,
			padding: u,
			isRoot: o
		}, f = this.getParent(t);
	...
	getData() {
		let t = this.getMindmap(), n = c(), r = a().layout !== void 0, i = n;
		...
		let o = [], s = [];
		this.flattenNodes(t, o), this.generateEdges(t, s), e.debug(`getData: processed ${o.length} nodes and ${s.length} edges`);
...
}, T = { draw: /* @__PURE__ */ t(async (t, r, a, o) => {
	e.debug("Rendering mindmap diagram\n" + t);
	let s = o.db, c = s.getData(), l = u(r, c.config.securityLevel);
	if (c.type = o.type, c.layoutAlgorithm = p(c.config.layout, { fallback: "cose-bilkent" }), c.diagramId = r, !s.getMindmap()) return;
	c.nodes.forEach((e) => {
	...
	let { themeVariables: m } = n(), { useGradient: h, gradientStart: g, gradientStop: _ } = m;
	if (h && g && _) {
	...
	d(l, c.config.mindmap?.padding ?? i.mindmap.padding, "mindmapDiagram", c.config.mindmap?.useMaxWidth ?? i.mindmap.useMaxWidth);
}, "draw") }, E = /* @__PURE__ */ t((e) => {
	let { theme: t, look: n } = e, i = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t], o(e["lineColor" + t]) ? e["lineColor" + t] = s(e["lineColor" + t], 20) : e["lineColor" + t] = r(e["lineColor" + t], 20);
	for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) {
		let a = "" + (n === "neo" ? Math.max(10 - (r - 1) * 2, 2) : 17 - 3 * r);
		i += `
	...
	return i;
}, "genSections"), D = /* @__PURE__ */ t((e, t, n) => {
	let r = "";
	for (let i = 0; i < e; i++) r += `
