...
import { A as r, F as i, b as a, s as o, z as s } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { a as c } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
...
}, "isIconAvailable"), St = /* @__PURE__ */ t(async (t, n, r) => {
	let i;
	try {
		i = await bt(t, n?.fallbackPrefix);
	} catch (t) {
		e.error(t), i = _t;
	}
	let o = fe(i, n);
...
t(Y, "applyStyle");
var jt = 16384;
async function Mt(e, t, n, c, l = !1, u = a()) {
...
async function Ft(e, t = {}) {
	...
	e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (e, r, i) => (n.push((async () => {
		let n = `${r}:${i}`;
		return await xt(n) ? await St(n, void 0, { class: "label-icon" }) : `<i class='${s(e, t).replace(":", " ")}'></i>`;
	})()), e));
	let r = await Promise.all(n);
	return e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, () => r.shift() ?? "");
}
t(Ft, "replaceIconSubstring");
var It = /* @__PURE__ */ t(async (t, i = "", { style: a = "", isTitle: o = !1, classes: s = "", useHtmlLabels: l = !0, markdown: u = !0, isNode: d = !0, width: f = 200, addSvgBackground: p = !1 } = {}, m) => {
	if (e.debug("XYZ createText", i, a, o, s, l, d, "addSvgBackground: ", p), l) {
		let e = await Ft(c(u ? Dt(i, m) : Et(i)), m), n = i.replace(/\\\\/g, "\\");
		return await Mt(t, {
			isNode: d,
			label: r(i) ? n : e,
		...
		let e = c(i.replace(/<br\s*\/?>/g, "<br/>")), r = Z(f, t, u ? Tt(e.replace("<br>", "<br/>"), m) : wt(e), i ? p : !1, !d);
		if (d) {
...
//#endregion
export { _t as a, yt as i, It as n, gt as o, St as r, Pt as t };
