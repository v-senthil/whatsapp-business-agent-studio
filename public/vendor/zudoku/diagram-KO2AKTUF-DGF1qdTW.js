import { b as e } from "./chunk-NNHCCRGN-PE4Czi2M.js";
import { t } from "./mermaid-parser.core-BfeNF3FH.js";
import { g as n, h as r, p as i } from "./src-CXddVwgO.js";
import { H as a, K as o, U as s, Y as c, a as l, b as u, f as d, v as f, w as p, x as m, y as h, z as g } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { _, i as ee, t as te } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { t as ne } from "./chunk-4BX2VUAB-j_w7t4i7.js";
...
r(S, "reset");
var oe = d.eventmodeling, se = /* @__PURE__ */ r(() => ee({
	...oe,
	...u().eventmodeling
}), "getConfig"), C = {};
function w() {
	let e = ce, { ast: t } = C, r = D();
	if (!t) throw Error("No data for EventModel");
	return t.frames.forEach((i, a) => {
		let o = P(i, t.dataEntities, r);
		e = J(e, {
			$kind: v,
			index: a,
			frame: i,
		...
		let s;
		V(i) ? (n.debug("source frame", i.sourceFrames), s = t.frames.filter((e) => i.sourceFrames.some((t) => t.$refText === e.name)), s.forEach((t) => {
			e = J(e, {
				$kind: b,
				index: a,
				frame: i,
...
r(N, "calculateEntityVisualProps");
function P(e, t, r) {
	let i = u(), a = g(k(e.entityIdentifier) ?? "", i), o, s = {
		...
		joinWith: "<br/>"
	}, c = `<b>${_(a, r.textMaxWidth, s)}</b>`;
	if (e.dataInlineValue && (o = e.dataInlineValue, o = o.substring(o.indexOf("{") + 1), o = o.substring(0, o.lastIndexOf("}") - 1), o = g(o, i), o = _(o, r.textMaxWidth, s), o = o.replaceAll(" ", "&nbsp;")), e.dataReference) {
		let n = t.find((t) => t.name === e.dataReference?.$refText);
		n && (o = n.dataBlockValue, o = o.substring(o.indexOf("{\n") + 2), o = o.substring(0, o.lastIndexOf("}") - 1), o = g(o, i), o = _(o, r.textMaxWidth, s), o = o.replaceAll(" ", "&nbsp;"), o += "<br/>");
	}
	let l = o !== void 0;
	l && (c += `<br/><br/><code style="text-align: left; display: block;max-width:${r.textMaxWidth}px">${o}</code>`);
	let d = {
		fontSize: s.fontSize,
	...
	return n.debug(`[${e.name}] ${e.entityIdentifier} text`, m), m;
}
r(P, "calculateTextProps");
function F(e, t) {
...
var Y = {
	...
	getDiagramProps: D,
	getState: w
}, de = { parse: /* @__PURE__ */ r(async (e) => {
	let r = await t("eventmodeling", e);
	n.debug(r), Y.setAst(r), ne(r, Y);
...
function Q(e, t, r, i) {
	return (a) => {
		...
		n.debug(`rendering relation up=${c} for `, {
		...
		e.append("path").attr("class", "em-relation").attr("fill", a.visual.fill).attr("stroke", p).attr("stroke-width", "1").attr("marker-end", `url(#${r})`).attr("d", `M${l} ${d} L${u} ${f}`);
	};
}
...
var pe = {
	...
	renderer: { draw: /* @__PURE__ */ r(function(e, t, r, a) {
		if (n.debug("in eventmodeling renderer", e + "\n", "id:", t, r), !fe) throw Error("EventModeling config not found");
