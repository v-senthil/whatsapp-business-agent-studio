...
import { t as n } from "./mermaid-parser.core-BfeNF3FH.js";
import { g as r, h as i, p as a } from "./src-CXddVwgO.js";
import { H as o, J as s, K as c, U as l, a as u, b as d, f, v as p, w as m, x as h, y as g, z as _ } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { c as v, i as y } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { t as b } from "./chunk-WU5MYG2G-yvpvq9O9.js";
import { a as x, i as S, n as C, r as w } from "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import { t as T } from "./chunk-4BX2VUAB-j_w7t4i7.js";
import { t as E } from "./cytoscape.esm-1-f6Rfhw.js";
...
var D = /* @__PURE__ */ t(((e, t) => {
...
}, N = /* @__PURE__ */ i(function(e) {
	return F(e) ? e === "L" ? "R" : "L" : e === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), P = /* @__PURE__ */ i(function(e) {
	let t = e;
	...
	let n = `${e}${t}`;
	return z(n) ? n : void 0;
}, "getArchitectureDirectionPair"), V = /* @__PURE__ */ i(function([e, t], n) {
	let r = n[0], i = n[1];
	return F(r) ? I(i) ? [e + (r === "L" ? -1 : 1), t + (i === "T" ? 1 : -1)] : [e + (r === "L" ? -1 : 1), t] : F(i) ? [e + (i === "L" ? 1 : -1), t + (r === "T" ? 1 : -1)] : [e, t + (r === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), ee = /* @__PURE__ */ i(function(e) {
	return e === "LT" || e === "TL" ? [1, 1] : e === "BL" || e === "LB" ? [1, -1] : e === "BR" || e === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), te = /* @__PURE__ */ i(function(e, t) {
	return L(e, t) ? "bend" : F(e) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), H = /* @__PURE__ */ i(function(e) {
	return e.type === "service";
}, "isArchitectureService"), ne = /* @__PURE__ */ i(function(e) {
	return e.type === "junction";
}, "isArchitectureJunction"), re = /* @__PURE__ */ i((e) => e.data(), "edgeData"), U = /* @__PURE__ */ i((e) => e.data(), "nodeData"), W = f.architecture, G = class {
	constructor() {
	...
	parse: /* @__PURE__ */ i(async (e) => {
		...
		r.debug(t);
		let i = K.parser?.yy;
		if (!(i instanceof G)) throw Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		ie(t, i);
	}, "parse")
}, q = /* @__PURE__ */ i((e) => `
  .edge {
...
`, "getStyles"), J = /* @__PURE__ */ i((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), Y = {
...
}, ae = /* @__PURE__ */ i(async function(e, t, n, r) {
	let i = n.getConfigField("padding"), a = n.getConfigField("iconSize"), o = a / 2, s = a / 6, c = s / 2;
	await Promise.all(t.edges().map(async (t) => {
		let { source: a, sourceDir: l, sourceArrow: u, sourceGroup: d, target: f, targetDir: p, targetArrow: m, targetGroup: g, label: _ } = re(t), { x: y, y: b } = t[0].sourceEndpoint(), { x, y: S } = t[0].midpoint(), { x: w, y: T } = t[0].targetEndpoint(), E = i + 4;
		if (d && (F(l) ? y += l === "L" ? -E : E : b += l === "T" ? -E : E + 18), g && (F(p) ? w += p === "L" ? -E : E : T += p === "T" ? -E : E + 18), !d && n.getNode(a)?.type === "junction" && (F(l) ? y += l === "L" ? o : -o : b += l === "T" ? o : -o), !g && n.getNode(f)?.type === "junction" && (F(p) ? w += p === "L" ? o : -o : T += p === "T" ? o : -o), t[0]._private.rscratch) {
			let t = e.insert("g");
			if (t.insert("path").attr("d", `M ${y},${b} L ${x},${S} L${w},${T} `).attr("class", "edge").attr("id", `${r}-${v(a, f, { prefix: "L" })}`), u) {
...
}, "drawEdges"), X = /* @__PURE__ */ i(async function(e, t, n, r) {
...
}, "drawGroups"), oe = /* @__PURE__ */ i(async function(e, t, n, r) {
	let i = h();
	for (let a of n) {
		...
		let s = n.append("g");
		if (a.icon) s.html(`<g>${await w(a.icon, {
			height: o,
			width: o,
			fallbackPrefix: Y.prefix
		})}</g>`);
	...
	return 0;
}, "drawServices"), Z = /* @__PURE__ */ i(function(e, t, n, r) {
	n.forEach((n) => {
...
function me(e, t, n, o, s, { spatialMaps: c, groupAlignments: l }) {
	return new Promise((u) => {
		...
		d.remove(), ue(n, f), se(e, f, s), ce(t, f, s), de(o, f);
...
var he = {
	...
	renderer: { draw: /* @__PURE__ */ i(async (e, t, n, r) => {
		...
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await oe(i, p, a, t), Z(i, p, o, t);
		let h = await me(a, o, c, l, i, u);
		await ae(f, h, i, t), await X(m, h, i, t), le(i, h), s(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
	styles: q
};
//#endregion
