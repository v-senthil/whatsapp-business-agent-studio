import { g as e, h as t, m as n } from "./src-CXddVwgO.js";
import { H as r, K as i, U as a, a as o, b as s, v as c, w as l, x as u, y as d } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { g as f } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import "./chunk-BSJP7CBP-D9ENIqdp.js";
import "./chunk-L5ZTLDWV-D-Agyo9x.js";
import { t as p } from "./chunk-55IACEB6-DwoZLfWV.js";
import { t as m } from "./chunk-2J33WTMH-CCkbVqsI.js";
import "./chunk-NZK2D7GU-vzBS4EZW.js";
import "./chunk-3OPIFGDE-BwYSS-16.js";
import "./chunk-KSCS5N6A-DgtFG-sx.js";
import { r as h, t as g } from "./chunk-LZXEDZCA-D8lb5wsM.js";
...
var v = _, y = class {
	constructor() {
		this.relations = [], this.latestRequirement = this.getInitialRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.latestElement = this.getInitialElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.direction = "TB", this.RequirementType = {
			...
			REFINES: "refines",
			TRACES: "traces"
		}, this.setAccTitle = a, this.getAccTitle = d, this.setAccDescription = r, this.getAccDescription = c, this.setDiagramTitle = i, this.getDiagramTitle = l, this.getConfig = /* @__PURE__ */ t(() => u().requirement, "getConfig"), this.clear(), this.setDirection = this.setDirection.bind(this), this.addRequirement = this.addRequirement.bind(this), this.setNewReqId = this.setNewReqId.bind(this), this.setNewReqRisk = this.setNewReqRisk.bind(this), this.setNewReqText = this.setNewReqText.bind(this), this.setNewReqVerifyMethod = this.setNewReqVerifyMethod.bind(this), this.addElement = this.addElement.bind(this), this.setNewElementType = this.setNewElementType.bind(this), this.setNewElementDocRef = this.setNewElementDocRef.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setCssStyle = this.setCssStyle.bind(this), this.setClass = this.setClass.bind(this), this.defineClass = this.defineClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	static {
...
n(S, { draw: () => C });
var C = /* @__PURE__ */ t(async function(t, n, r, i) {
	e.info("REF0:"), e.info("Drawing requirement diagram (unified)", n);
	let { securityLevel: a, state: o, layout: s, look: c } = u(), l = i.db.getData(), d = p(n, a);
	l.type = i.type, l.layoutAlgorithm = g(s), l.nodeSpacing = o?.nodeSpacing ?? 50, l.rankSpacing = o?.rankSpacing ?? 50, l.markers = c === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], l.diagramId = n, await h(l, d), f.insertTitle(d, "requirementDiagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), m(d, 8, "requirementDiagram", o?.useMaxWidth ?? !0);
}, "draw"), w = {
	parser: v,
	get db() {
		return new y();
