...
import { g as t, h as n, p as r } from "./src-CXddVwgO.js";
import { H as i, K as a, U as o, Y as s, a as c, b as l, f as u, s as d, v as f, w as p, x as m, y as h } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { g, i as _, m as v } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { t as y } from "./chunk-4BX2VUAB-j_w7t4i7.js";
import { t as b } from "./chunk-QZHKN3VN-Bm74hFbO.js";
...
var te = /* @__PURE__ */ n(function(e) {
...
}, "setDirection"), ne = /* @__PURE__ */ n(function(e) {
...
}, "setOptions"), re = /* @__PURE__ */ n(function() {
	return C.records.options;
}, "getOptions"), ie = /* @__PURE__ */ n(function(e) {
	let n = e.msg, r = e.id, i = e.type, a = e.tags;
	...
	C.records.head = s, t.info("main branch", o.mainBranchName), C.records.commits.has(s.id) && t.warn(`Commit ID ${s.id} already exists`), C.records.commits.set(s.id, s), C.records.branches.set(C.records.currBranch, s.id), t.debug("in pushCommit " + s.id);
}, "commit"), ae = /* @__PURE__ */ n(function(e) {
	let n = e.name, r = e.order;
	if (n = d.sanitizeText(n, S()), C.records.branches.has(n)) throw Error(`Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${n}")`);
	C.records.branches.set(n, C.records.head == null ? null : C.records.head.id), C.records.branchConfig.set(n, {
		name: n,
		order: r
	}), E(n), t.debug("in createBranch");
}, "branch"), oe = /* @__PURE__ */ n((e) => {
	let n = e.branch, r = e.id, i = e.type, a = e.tags, o = S();
	n = d.sanitizeText(n, o), r &&= d.sanitizeText(r, o);
	let s = C.records.branches.get(C.records.currBranch), c = C.records.branches.get(n), l = s ? C.records.commits.get(s) : void 0, u = c ? C.records.commits.get(c) : void 0;
	...
	C.records.head = p, C.records.commits.set(p.id, p), C.records.branches.set(C.records.currBranch, p.id), t.debug(C.records.branches), t.debug("in mergeBranch");
}, "merge"), se = /* @__PURE__ */ n(function(e) {
	let n = e.id, r = e.targetId, i = e.tags, a = e.parent;
	t.debug("Entering cherryPick:", n, r, i);
	let o = S();
	if (n = d.sanitizeText(n, o), r = d.sanitizeText(r, o), i = i?.map((e) => d.sanitizeText(e, o)), a = d.sanitizeText(a, o), !n || !C.records.commits.has(n)) {
	...
	if (!r || !C.records.commits.has(r)) {
		...
		C.records.head = l, C.records.commits.set(l.id, l), C.records.branches.set(C.records.currBranch, l.id), t.debug(C.records.branches), t.debug("in cherryPick");
	}
}, "cherryPick"), E = /* @__PURE__ */ n(function(e) {
...
function O(e) {
	...
	if (t.debug(i.join(" ")), n.parents && n.parents.length == 2 && n.parents[0] && n.parents[1]) {
		let t = C.records.commits.get(n.parents[0]);
		D(e, n, t), n.parents[1] && e.push(C.records.commits.get(n.parents[1]));
...
n(O, "prettyPrintCommitHistory");
var ce = /* @__PURE__ */ n(function() {
	t.debug(C.records.commits);
	let e = k()[0];
	O([e]);
}, "prettyPrint"), le = /* @__PURE__ */ n(function() {
	C.reset(), c();
}, "clear"), ue = /* @__PURE__ */ n(function() {
...
}, "getBranchesAsObjArray"), de = /* @__PURE__ */ n(function() {
	return C.records.branches;
}, "getBranches"), fe = /* @__PURE__ */ n(function() {
	return C.records.commits;
}, "getCommits"), k = /* @__PURE__ */ n(function() {
...
}, "populate"), me = /* @__PURE__ */ n((e, r) => {
	let i = {
		Commit: /* @__PURE__ */ n((e) => r.commit(he(e)), "Commit"),
		Branch: /* @__PURE__ */ n((e) => r.branch(ge(e)), "Branch"),
		Merge: /* @__PURE__ */ n((e) => r.merge(_e(e)), "Merge"),
		Checkout: /* @__PURE__ */ n((e) => r.checkout(ve(e)), "Checkout"),
		CherryPicking: /* @__PURE__ */ n((e) => r.cherryPick(ye(e)), "CherryPicking")
	}[e.$type];
	i ? i(e) : t.error(`Unknown statement type: ${e.$type}`);
}, "parseStatement"), he = /* @__PURE__ */ n((e) => ({
	id: e.id,
	msg: e.message ?? "",
	type: e.type === void 0 ? x.NORMAL : x[e.type],
	tags: e.tags ?? void 0
}), "parseCommit"), ge = /* @__PURE__ */ n((e) => ({
	name: e.name,
	order: e.order ?? 0
}), "parseBranch"), _e = /* @__PURE__ */ n((e) => ({
	branch: e.branch,
	id: e.id ?? "",
	type: e.type === void 0 ? void 0 : x[e.type],
	tags: e.tags ?? void 0
}), "parseMerge"), ve = /* @__PURE__ */ n((e) => e.branch, "parseCheckout"), ye = /* @__PURE__ */ n((e) => ({
	id: e.id,
	targetId: "",
	tags: e.tags?.length === 0 ? void 0 : e.tags,
	parent: e.parent
}), "parseCherryPicking"), be = { parse: /* @__PURE__ */ n(async (n) => {
	...
	"redux-dark-color",
	"neo-dark"
]), z = /* @__PURE__ */ n((e, t, n = !1) => n && e > 0 ? (e - 1) % (t - 1) + 1 : e % t, "calcColorIndex"), B = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), H = 30, U = /* @__PURE__ */ new Map(), W = [], G = 0, K = "LR", Se = /* @__PURE__ */ n(() => {
	B.clear(), V.clear(), U.clear(), G = 0, W = [], K = "LR";
}, "clear"), q = /* @__PURE__ */ n((e) => {
...
}, "drawText"), J = /* @__PURE__ */ n((e) => {
	let t, r, i;
	return K === "BT" ? (r = /* @__PURE__ */ n((e, t) => e <= t, "comparisonFunc"), i = Infinity) : (r = /* @__PURE__ */ n((e, t) => e >= t, "comparisonFunc"), i = 0), e.forEach((e) => {
		let n = K === "TB" || K == "BT" ? V.get(e)?.y : V.get(e)?.x;
		n !== void 0 && r(n, i) && (t = e, i = n);
	}), t;
}, "findClosestParent"), Ce = /* @__PURE__ */ n((e) => {
	let t = "", n = Infinity;
	return e.forEach((e) => {
		let r = V.get(e).y;
		r <= n && (t = e, n = r);
	}), t || void 0;
}, "findClosestParentBT"), we = /* @__PURE__ */ n((e, t, n) => {
	let r = n, i = n, a = [];
	e.forEach((e) => {
		let n = t.get(e);
...
}, "setParallelBTPos"), Te = /* @__PURE__ */ n((e) => {
	...
	return n;
}, "findClosestParentPos"), Ee = /* @__PURE__ */ n((e) => Te(e) + M, "calculateCommitPosition"), De = /* @__PURE__ */ n((e, t) => {
...
}, "setCommitPosition"), Oe = /* @__PURE__ */ n((e, t, n) => {
...
}, "setRootPosition"), ke = /* @__PURE__ */ n((e, t, n, r, i, a) => {
...
}, "drawCommitBullet"), Ae = /* @__PURE__ */ n((e, t, n, r, i) => {
...
}, "drawCommitLabel"), je = /* @__PURE__ */ n((e, t, n, r) => {
	if (t.tags.length > 0) {
		let i = 0, a = 0, o = 0, s = [];
...
}, "drawCommitTags"), Me = /* @__PURE__ */ n((e) => {
...
}, "getCommitClassType"), Ne = /* @__PURE__ */ n((e, t, n, r) => {
	let i = {
		x: 0,
		y: 0
	};
	...
	return 0;
}, "calculatePosition"), Pe = /* @__PURE__ */ n((e, t, n) => {
...
}, "getCommitPosition"), Y = /* @__PURE__ */ n((e, t, r, i) => {
	let a = e.append("g").attr("class", "commit-bullets"), o = e.append("g").attr("class", "commit-labels"), s = K === "TB" || K === "BT" ? H : 0, c = [...t.keys()], l = i.parallelCommits ?? !1, u = /* @__PURE__ */ n((e, n) => {
		let r = t.get(e)?.seq, i = t.get(n)?.seq;
		return r !== void 0 && i !== void 0 ? r - i : 0;
	}, "sortKeys"), d = c.sort(u);
	K === "BT" && (l && we(d, t, s), d = d.reverse()), d.forEach((e) => {
		let n = t.get(e);
		if (!n) throw Error(`Commit not found for key ${e}`);
		l && (s = Ne(n, K, s, V));
		let c = Pe(n, s, l);
		if (r) {
			let e = Me(n), t = n.customType ?? n.type;
			ke(a, n, c, e, B.get(n.branch)?.index ?? 0, t), Ae(o, n, c, s, i), je(o, n, c, s);
		}
		K === "TB" || K === "BT" ? V.set(n.id, {
			x: c.x,
			y: c.posWithOffset
		}) : V.set(n.id, {
			x: c.posWithOffset,
...
}, "drawCommits"), Fe = /* @__PURE__ */ n((e, t, r, i, a) => {
	let o = (K === "TB" || K === "BT" ? r.x < i.x : r.y < i.y) ? t.branch : e.branch, s = /* @__PURE__ */ n((e) => e.branch === o, "isOnBranchToGetCurve"), c = /* @__PURE__ */ n((n) => n.seq > e.seq && n.seq < t.seq, "isBetweenCommits");
	return [...a.values()].some((e) => c(e) && s(e));
}, "shouldRerouteArrow"), X = /* @__PURE__ */ n((e, t, n = 0) => {
	let r = e + Math.abs(e - t) / 2;
	return n > 5 ? r : W.every((e) => Math.abs(e - r) >= 10) ? (W.push(r), r) : X(e, t - Math.abs(e - t) / 5, n + 1);
}, "findLane"), Ie = /* @__PURE__ */ n((e, t, n, r) => {
...
}, "drawArrows"), Re = /* @__PURE__ */ n((e, t, n, r) => {
...
}, "drawBranches"), ze = /* @__PURE__ */ n(function(e, t, n, r, i) {
	return B.set(e, {
		pos: t,
		index: n
	}), t += 50 + (i ? 40 : 0) + (K === "TB" || K === "BT" ? r.width / 2 : 0), t;
}, "setBranchPosition"), Be = { draw: /* @__PURE__ */ n(function(e, n, i, a) {
	Se(), t.debug("in gitgraph renderer", e + "\n", "id:", n, i);
	let o = a.db;
	if (!o.getConfig) {
	...
	K = o.getDirection();
	let d = r(`[id="${n}"]`), { look: f, theme: p, themeVariables: h } = m(), { useGradient: _, gradientStart: v, gradientStop: y, filterColor: b } = h;
	if (_) {
		let e = d.append("defs").append("linearGradient").attr("id", n + "-gradient").attr("gradientUnits", "objectBoundingBox").attr("x1", "0%").attr("y1", "0%").attr("x2", "100%").attr("y2", "0%");
	...
	f === "neo" && I.has(p ?? "") && d.append("defs").append("filter").attr("id", n + "-drop-shadow").attr("height", "130%").attr("width", "130%").append("feDropShadow").attr("dx", "4").attr("dy", "4").attr("stdDeviation", 0).attr("flood-opacity", "0.06").attr("flood-color", b);
	let x = 0;
	u.forEach((e, t) => {
	...
	}), Y(d, U, !1, c), c.showBranches && Re(d, u, c, n), Le(d, U), Y(d, U, !0, c), g.insertTitle(d, "gitTitleText", c.titleTopMargin ?? 0, o.getDiagramTitle()), s(void 0, d, c.diagramPadding, c.useMaxWidth);
