...
import { D as r, H as i, K as a, U as o, a as s, b as c, c as l, f as u, v as d, w as f, y as p } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
...
var _ = {
	...
	let i = r.db, a = i.getAxes(), o = i.getCurves(), s = i.getOptions(), c = i.getConfig(), l = i.getDiagramTitle(), u = M(h(t), c), d = s.max ?? Math.max(...o.map((e) => Math.max(...e.entries))), f = s.min, p = Math.min(c.width, c.height) / 2;
	N(u, a, p, s.ticks, s.graticule), P(u, a, p, c), F(u, a, o, f, d, s.graticule, c), R(u, o, s.showLegend, c), u.append("text").attr("class", "radarTitle").text(l).attr("x", 0).attr("y", -c.height / 2 - c.marginTop);
	...
	return l(e, r, n, t.useMaxWidth ?? !0), e.attr("viewBox", `0 0 ${n} ${r}`), e.append("g").attr("transform", `translate(${i.x}, ${i.y})`);
