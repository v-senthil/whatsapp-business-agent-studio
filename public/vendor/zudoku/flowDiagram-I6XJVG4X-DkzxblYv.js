...
import { $ as r, G as i, H as a, K as o, U as s, a as c, d as l, it as u, s as d, v as f, w as ee, x as p, y as m } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { t as h } from "./channel-LkPLlkYs.js";
import { c as g, g as _ } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import { t as te } from "./chunk-FMBD7UC4-CYttHLFx.js";
import "./chunk-BSJP7CBP-D9ENIqdp.js";
import "./chunk-L5ZTLDWV-D-Agyo9x.js";
import { t as ne } from "./chunk-ND2GUHAM-DBZVMcxd.js";
import { t as re } from "./chunk-55IACEB6-DwoZLfWV.js";
import { t as v } from "./chunk-2J33WTMH-CCkbVqsI.js";
import "./chunk-NZK2D7GU-vzBS4EZW.js";
import { o as y } from "./chunk-3OPIFGDE-BwYSS-16.js";
import "./chunk-KSCS5N6A-DgtFG-sx.js";
import { r as b, t as x } from "./chunk-LZXEDZCA-D8lb5wsM.js";
import { n as S, t as C } from "./chunk-XPW4576I-CNNdiTBE.js";
...
var w = "flowchart-", T = class {
	...
	addVertex(t, n, r, i, a, o, s = {}, c) {
		...
		let d, f = this.vertices.get(t);
		if (f === void 0 && (n === void 0 && r === void 0 && i != null && e.warn(`Style applied to unknown node "${t}". This may indicate a typo. The node will be created automatically.`), f = {
			id: t,
			labelType: "text",
			domId: w + t + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(t, f)), this.vertexCounter++, n === void 0 ? f.text === void 0 && (f.text = t) : (this.config = p(), d = this.sanitizeText(n.text.trim()), f.labelType = n.type, d.startsWith("\"") && d.endsWith("\"") && (d = d.substring(1, d.length - 1)), f.text = d), r !== void 0 && (f.type = r), i?.forEach((e) => {
			f.styles.push(e);
		}), a?.forEach((e) => {
			f.classes.push(e);
...
You have to call mermaid.initialize.`);
	...
	addSubGraph(n, r, i) {
		...
		}, "uniq"))(r.flat()), c = s.nodeList, l = s.dir, u = p().flowchart ?? {};
		...
		return e.info("Adding", d.id, d.nodes, d.dir), d.nodes = this.makeUniq(d, this.subGraphs).nodes, this.subGraphs.push(d), this.subGraphLookup.set(a, d), a;
	}
	getPosForId(e) {
	...
	draw: /* @__PURE__ */ t(async function(t, n, r, i) {
		...
		i.db.setDiagramId(n), e.debug("Before getData: ");
		let c = i.db.getData();
		e.debug("Data: ", c);
		let l = re(n, a), u = i.db.getDirection();
		c.type = i.type, c.layoutAlgorithm = x(s), c.layoutAlgorithm === "dagre" && s === "elk" && e.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), c.direction = u, c.nodeSpacing = o?.nodeSpacing || 50, c.rankSpacing = o?.rankSpacing || 50, c.markers = [
			"point",
			"circle",
			"cross"
		], c.diagramId = n, e.debug("REF1:", c), await b(c, l);
	...
	var e = /* @__PURE__ */ t(function(e, t, n, r) {
		...
		parse: /* @__PURE__ */ t(function(e) {
			var n = this, r = [0], i = [], a = [null], o = [], s = this.table, c = "", l = 0, u = 0, d = 0, f = 2, ee = 1, p = o.slice.call(arguments, 1), m = Object.create(this.lexer), h = { yy: {} };
