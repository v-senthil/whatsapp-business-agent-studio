...
import { H as n, K as r, U as i, a, s as o, v as s, w as c, x as l, y as u } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { g as d, s as f } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { t as p } from "./chunk-55IACEB6-DwoZLfWV.js";
import { t as m } from "./chunk-2J33WTMH-CCkbVqsI.js";
import { r as h } from "./chunk-LZXEDZCA-D8lb5wsM.js";
...
t(K, "stateDomId");
var me = /* @__PURE__ */ t((t, n, r, i, a, s, c, u) => {
	e.trace("items", n), n.forEach((e) => {
		switch (e.stmt) {
			...
			case C:
				{
					X(t, e.state1, r, i, a, s, c, u), X(t, e.state2, r, i, a, s, c, u);
					let n = c === "neo", d = {
						id: "edge" + G,
						start: e.state1.id,
						end: e.state2.id,
						...
						style: k,
						labelStyle: "",
						label: o.sanitizeText(e.description ?? "", l()),
						arrowheadStyle: A,
						labelpos: j,
						labelType: M,
						thickness: N,
...
var X = /* @__PURE__ */ t((t, n, r, i, a, s, c, u) => {
	...
	n.doc && (e.trace("Adding nodes children "), me(n, n.doc, r, i, a, !s, c, u));
	...
	addState(t, n = D, r = void 0, i = void 0, a = void 0, s = void 0, c = void 0, u = void 0) {
		let d = t?.trim();
