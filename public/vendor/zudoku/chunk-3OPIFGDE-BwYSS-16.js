...
import { A as r, B as i, M as a, T as o, b as s, g as c, x as l, z as u } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import { a as d, r as f, u as p } from "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import { n as m, r as h } from "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import { n as g, t as _ } from "./chunk-L5ZTLDWV-D-Agyo9x.js";
import { a as v, i as y, r as b, t as x } from "./chunk-NZK2D7GU-vzBS4EZW.js";
import { t as S } from "./rough.esm-B7woRVjF.js";
...
var C = /* @__PURE__ */ t(async (e, t, r) => {
	...
	let h = !!t.icon || !!t.img, g = t.labelType === "markdown", v = await m(s, u(d(f), l()), {
		useHtmlLabels: a,
	...
	let i = r.useHtmlLabels ?? o(l()), a = e.insert("g").attr("class", "label").attr("style", r.labelStyle || ""), s = await m(a, u(d(t), l()), {
		useHtmlLabels: i,
...
async function ue(t, n, r) {
	...
	n.labelStyle = i;
	let { shapeSvg: o, bbox: s, halfPadding: c } = await C(t, n, E(n)), l = r?.padding ?? c, u = n.look === "neo" ? s.width / 2 + 32 : s.width / 2 + l, d, { cssStyles: f } = n;
	if (n.look === "handDrawn") {
...
async function Ee(t, n) {
	...
	n.labelStyle = r;
	let o = n.padding ?? 0, s = n.look === "neo" ? 16 : o, { shapeSvg: c, bbox: l } = await C(t, n, E(n)), u = (n?.width ? n?.width / 2 : l.width / 2) + (s ?? 0), d = u - a, f, { cssStyles: m } = n;
	if (n.look === "handDrawn") {
		let e = S.svg(c), t = v(n, {
			roughness: .2,
			strokeWidth: 2.5
	...
	return T(n, f), n.intersect = function(t) {
		return e.info("DoubleCircle intersect", n, u, t), W.circle(n, u, t);
	}, c;
}
t(Ee, "doublecircle");
function De(t, n, { config: { themeVariables: r } }) {
	let { labelStyles: i, nodeStyles: a } = y(n);
...
t(Le, "iconCircle");
async function Re(t, n, { config: { themeVariables: r, flowchart: i } }) {
	let { labelStyles: a } = y(n);
	n.labelStyle = a;
	let o = n.assetHeight ?? 48, s = n.assetWidth ?? 48, c = Math.max(o, s), l = i?.wrappingWidth;
	n.width = Math.max(c, l ?? 0);
...
t(Re, "iconRounded");
async function ze(t, n, { config: { themeVariables: r, flowchart: i } }) {
	let { labelStyles: a } = y(n);
	n.labelStyle = a;
	let o = n.assetHeight ?? 48, s = n.assetWidth ?? 48, c = Math.max(o, s), l = i?.wrappingWidth;
	n.width = Math.max(c, l ?? 0);
...
t(ze, "iconSquare");
async function Be(t, n, { config: { flowchart: r } }) {
	let i = new Image();
...
async function At(t, n) {
	...
	n.labelStyle = r;
	let a = n.padding ?? 0, o = n.look === "neo" ? a * 2 : a;
	(n.width || n.height) && (n.width = ((n?.width ?? 0) - o) / 2, n.width < kt && (n.width = kt), n.height = n?.height ?? 0, n.height < Ot && (n.height = Ot));
	let { shapeSvg: s, bbox: u, label: d } = await C(t, n, E(n)), f = c(l().flowchart?.htmlLabels), p = (n?.width ? n?.width : u.width) + o, m = n?.height ? n?.height : p + u.height, h = m, g = [
		{
			x: 0,
			y: 0
		},
...
async function It(e, t) {
	...
	let x = E(t);
	x ||= "node default";
	let C = e.insert("g").attr("class", x).attr("id", t.domId || t.id), w = await Lt(C, t.label ?? "", p, 0, 0, ["name"], _);
	w.height += h;
	...
	if (T(t, ie), b && t.look !== "handDrawn") if (i != null && Ft.has(i)) C.selectAll("path").attr("style", b);
	else {
...
t(zt, "textHelper");
async function Bt(e, a, o, l = []) {
	let u = e.insert("g").attr("class", "label").attr("style", l.join("; ")), p = s(), h = "useHtmlLabels" in a ? a.useHtmlLabels : c(p.htmlLabels) ?? !0, g = "";
...
async function Vt(e, t) {
	...
	let { shapeSvg: f, bbox: p } = await zt(e, t, r, u, s), { labelStyles: m, nodeStyles: h } = y(t);
...
async function $(e, t, r, a = "") {
	if (t === "") return 0;
	let o = e.insert("g").attr("class", "label").attr("style", a), s = l(), c = s.htmlLabels ?? !0, u = await m(o, i(d(t)), {
		width: f(t, s) + 50,
		classes: "markdown-node-label",
		useHtmlLabels: c,
		style: a
