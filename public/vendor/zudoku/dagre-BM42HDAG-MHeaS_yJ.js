...
import { x as n } from "./chunk-CSCIHK7Q-CHXp-B5u.js";
import "./chunk-5ZQYHXKU-Ckg5JQ60.js";
import "./chunk-O5CBEL6O-Cz2Xr9Qv.js";
import "./chunk-BSJP7CBP-D9ENIqdp.js";
import { n as r } from "./chunk-L5ZTLDWV-D-Agyo9x.js";
import { r as i, t as a } from "./graphlib-ZWHIaefB.js";
import { n as o, r as s, t as c } from "./dagre-dOzDPqmI.js";
import "./chunk-NZK2D7GU-vzBS4EZW.js";
import { a as l, c as u, i as d, l as f, n as p, t as m, u as h } from "./chunk-3OPIFGDE-BwYSS-16.js";
import { a as g, i as _, n as v, r as y, t as b } from "./chunk-KSCS5N6A-DgtFG-sx.js";
...
var E = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ t(() => {
	...
	for (let i of r) if (e.debug("Extracting node", i, E, E.has(i) && !E.get(i).externalConnections, !t.parent(i), t.node(i), t.children("D"), " Depth ", n), !E.has(i)) e.debug("Not a cluster", i, n);
		...
		e.warn("Old graph before copy", C(t)), M(i, t, o, i), t.setNode(i, {
			clusterNode: !0,
			id: i,
			clusterData: E.get(i).clusterData,
			label: E.get(i).label,
			graph: o
		}), e.warn("New graph after copy node: (", i, ")", C(o)), e.debug("Old graph after copy", C(t));
	...
	await Promise.all(i.nodes().map(async function(t) {
		...
		if (e.info("(Insert) Node XXX" + t + ": " + JSON.stringify(i.node(t))), n?.clusterNode) {
	...
	return await Promise.all(B(i).map(async function(t) {
		let n = i.node(t);
		if (e.info("Position XBX => " + t + ": (" + n.x, "," + n.y, ") width: ", n.width, " height: ", n.height), n?.clusterNode) n.y += D, e.info("A tainted cluster node XBX1", t, n.id, n.width, n.height, n.x, n.y, i.parent(t)), E.get(n.id).node = n, u(n);
			...
			e.debug("OffsetY", o, "labelHeight", a, "halfPadding", r), await d(b, n), E.get(n.id).node = n;
		} else {
			let t = i.node(n.parentId);
			n.y += D / 2, e.info("A regular node XBX1 - using the padding", n.id, "parent", n.parentId, n.width, n.height, n.x, n.y, "offsetY", n.offsetY, "parent", t, t?.offsetY, n), u(n);
		}
	...
	_(o, t.markers, t.type, t.diagramId), p(), b(), m(), k(), t.nodes.forEach((e) => {
	...
	let s = n();
	await V(o, i, t.type, t.diagramId, void 0, s);
}, "render");
//#endregion
export { H as render };
