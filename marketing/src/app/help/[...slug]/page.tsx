...
// The static export must not render pages the user did not intend to publish.
// Every param comes from generateStaticParams, so dynamic slugs never reach
// this page in a Pages deploy; keep the guard for defence-in-depth anyway.
